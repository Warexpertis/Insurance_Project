package com.wrxprts.ims.config;
...
public class SecurityConfiguration
{
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception
	{
		 ...
		 * .permitAll().requestMatchers("/user_page/**").permitAll()
		 * .requestMatchers("/users").hasRole("ADMIN")) .formLogin(form ->
		 * form.loginPage("/login").loginProcessingUrl("/login")
		 * .defaultSuccessUrl("/user_page").permitAll()) .logout(logout ->
